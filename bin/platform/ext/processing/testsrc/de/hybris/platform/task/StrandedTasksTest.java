...
public class StrandedTasksTest extends ServicelayerBaseTest
{
	...
	{
		final TaskModel processedTaskModel = runBaseScenarioAndReturnProcessedTask(ErrorType.NONE, 1, "Marked as failed task with pk: ");
	...
	{
		final TaskModel processedTaskModel = runBaseScenarioAndReturnProcessedTask(ErrorType.FAIL, 2, "Unlocked task with pk: ");

		// TASK SHOULD NOT BE AVAILABLE ON DB
	...
	{
		final TaskModel processedTaskModel = runBaseScenarioAndReturnProcessedTask(ErrorType.RETRY, 2, "Marked to retry task with pk: ","Unlocked task with pk: ");
	...
	private TaskModel runBaseScenarioAndReturnProcessedTask(final ErrorType errorType, final int expectedTaskRunNumber,
	                                                        final String ... strandedTaskHandlerLogMsg) throws InterruptedException
	{
		...
		// task should be marked as not finished
