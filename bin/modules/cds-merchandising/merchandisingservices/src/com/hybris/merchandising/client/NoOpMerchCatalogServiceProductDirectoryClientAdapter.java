...
{
	private static final String HANDLE_PRODUCT_BATCH = "handleProductsBatch invoked";
	private static final String HANDLE_PRODUCT_BATCH_ASYNC = "handleProductsBatchAsynch invoked";
	...
	{
		LOG.debug(HANDLE_PRODUCT_BATCH);
	...
	{
		LOG.debug(HANDLE_PRODUCT_BATCH_ASYNC);
		processBatch(productDirectoryId, (String) null, products);
	...
	@Override
	public String handleProductsBatch(final String productDirectoryId, final String version, final List<Product> products)
	{
		LOG.debug(HANDLE_PRODUCT_BATCH);
		return processBatch(productDirectoryId, version, products);
	...
	@Override
	public Observable<String> handleProductsBatchAsync(final String productDirectoryId, final String version, final List<Product> products)
	{
		LOG.debug(HANDLE_PRODUCT_BATCH_ASYNC);
		processBatch(productDirectoryId, (String) null, products);
		return Observable.empty();
	...
	{
		return processBatch(productDirectoryId, version == null ? null : version.toString(), products);
	}
	 ...
	 */
	private String processBatch(final String productDirectoryId,
	                            final String version, final List<Product> products)
	{
		if (version != null)
		{
