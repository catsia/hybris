...
{
	private static final String SERIALIZING_ERROR_MESSAGE = "An error occurred serializing products to string";
	 ...
	 */
	@Override
	public Observable<String> handleProductsBatchAsync(final String productDirectoryId, final String version,
	                                                   final List<Product> products)
	{
		if (LOG.isDebugEnabled())
		{
			...
			{
				LOG.error(SERIALIZING_ERROR_MESSAGE, e);
			}
		}
