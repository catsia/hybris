...
public class PointOfServicePopulatorTest
{
	...
	private static final String POS_BOPIS_INSTRUCTIONS = "Pick up from desk";
	...
	public void testConvert()
	{
		...
		given(pointOfServiceModel.getPickUpInStoreInstructions()).willReturn(POS_BOPIS_INSTRUCTIONS);
		...
		Assert.assertEquals(POS_BOPIS_INSTRUCTIONS, pointOfServiceData.getPickUpInStoreInstructions());
	}
