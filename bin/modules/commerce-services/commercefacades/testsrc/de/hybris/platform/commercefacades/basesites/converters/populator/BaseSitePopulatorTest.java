...
public class BaseSitePopulatorTest
{
	...
	@Mock
	private CaptchaConfigData captchaConfigData;
	@Mock
	...
	public void setUp() throws Exception
	{
		...
		when(captchaConfigConverter.convert(baseSiteModel)).thenReturn(captchaConfigData);
	}
	...
	public void populate()
	{
		...
		assertTrue(baseSiteData.isDataIsolationEnabled());
		assertEquals(captchaConfigData, baseSiteData.getCaptchaConfig());
	}
	...
	public void populateWithOptionalFieldsEqualToNull()
	{
		...
		assertFalse(baseSiteData.isDataIsolationEnabled());
	}
}
