...
public class SearchResultFacetsPopulator implements
		Populator<SnSearchResultConverterData<SnSearchQuery, SnSearchResult>, ProductCategorySearchPageData<SolrSearchQueryData, SearchResultValueData, CategoryModel>>
{
	@Override
	...
	protected boolean containsSearchResult(final SnSearchResultConverterData<SnSearchQuery, SnSearchResult> source)
	{
		return source.getSnSearchResult() != null;
	}

	protected List<FacetData<SolrSearchQueryData>> buildFacets(
			final SnSearchResultConverterData<SnSearchQuery, SnSearchResult> source, final SolrSearchQueryData searchQuery)
	{
