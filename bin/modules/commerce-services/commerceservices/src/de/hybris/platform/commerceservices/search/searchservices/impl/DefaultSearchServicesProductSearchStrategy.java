		...
		ProductSearchStrategy<SolrSearchQueryData, ITEM, ProductCategorySearchPageData<SolrSearchQueryData, ITEM, CategoryModel>, AutocompleteSuggestion>
{
	...
	protected static final int DEFAULT_TOP = 10;
	...
	private Converter<SnSearchResultConverterData<SnSearchQuery, SnSearchResult>, ProductCategorySearchPageData<SolrSearchQueryData, ITEM, CategoryModel>> searchResultConverter;
	...
	protected SnSuggestQuery createSuggestQuery(final String input)
	{
		...
		suggestQuery.setTop(DEFAULT_TOP);
			...
			final SolrSearchQueryData searchQuery, final PageableData pageable)
	{
		...
		try
		{
			...
			return convertSearchResult(snSearchQuery, snSearchResponse, searchQuery);
		}
		catch (final SnException e)
		{
	...
	protected ProductCategorySearchPageData<SolrSearchQueryData, ITEM, CategoryModel> convertSearchResult(
			final SnSearchQuery snSearchQuery, final SnSearchResponse snSearchResponse, final SolrSearchQueryData searchQuery)
	{
		final SnSearchResultConverterData<SnSearchQuery, SnSearchResult> source = new SnSearchResultConverterData<>();
		source.setIndexConfiguration(snSearchResponse.getIndexConfiguration());
		source.setIndexType(snSearchResponse.getIndexType());
		source.setSnSearchQuery(snSearchQuery);
	...
	public Converter<SnSearchResultConverterData<SnSearchQuery, SnSearchResult>, ProductCategorySearchPageData<SolrSearchQueryData, ITEM, CategoryModel>> getSearchResultConverter()
	{
	...
	public void setSearchResultConverter(
			final Converter<SnSearchResultConverterData<SnSearchQuery, SnSearchResult>, ProductCategorySearchPageData<SolrSearchQueryData, ITEM, CategoryModel>> searchResultConverter)
	{
