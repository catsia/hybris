...
public class DefaultCustomerService implements CustomerService
{
	 ...
	 * @param regexp      regular expression for UUID validation
	 */
	...
	@Override
	public Optional<CustomerModel> getFirstCustomerByBaseSitePK(final PK baseSitePK)
	{
		return getCustomerDao().findFirstCustomerByBaseSitePK(baseSitePK);
	}
