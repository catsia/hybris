...
public class CoreDataImportServiceTest
{
	...
	public void testImportExecutionWithNoResponsiveImpexFiles()
	{
		...
		Mockito.doReturn(null).when(coreDataImportService).getFileResource(RESPONSIVE_CONTENT_FILE);
		Mockito.doReturn(null).when(coreDataImportService).getFileResource(RESPONSIVE_SITE_FILE);
		Mockito.doReturn(null).when(coreDataImportService).getFileResource(RESPONSIVE_STORE_FILE);
	...
	public void testImportExecutionWithResponsiveImpexFiles() throws FileNotFoundException
	{
		...
		given(Boolean.valueOf(coreDataImportService.isResponsive())).willReturn(Boolean.TRUE);
		Mockito.doReturn(Mockito.mock(URL.class)).when(coreDataImportService).getFileResource(RESPONSIVE_CONTENT_FILE);
		Mockito.doReturn(Mockito.mock(URL.class)).when(coreDataImportService).getFileResource(RESPONSIVE_SITE_FILE);
		Mockito.doReturn(Mockito.mock(URL.class)).when(coreDataImportService).getFileResource(RESPONSIVE_STORE_FILE);
