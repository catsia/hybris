...
public class DefaultCMSVersionFacade implements CMSVersionFacade
{
			...
			final PageableData pageableData) throws CMSItemNotFoundException
	{
		...
		final CMSItemModel cmsItemModel = getUniqueItemIdentifierService().getItemModel(itemUUID, CMSItemModel.class).orElseThrow(() ->  new CMSItemNotFoundException(itemUUID + "is not exist"));
