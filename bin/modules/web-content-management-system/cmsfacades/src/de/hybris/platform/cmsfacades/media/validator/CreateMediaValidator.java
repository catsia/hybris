...
public class CreateMediaValidator implements Validator
{
	...
	private Predicate<MediaData> mediaCodeExistsPredicate;
	...
	public void validate(final Object obj, final Errors errors)
	{
		...
		else if (!Objects.isNull(target.getCode()) && getMediaCodeExistsPredicate().test(target))
		{
	...
	protected Predicate<MediaData> getMediaCodeExistsPredicate()
	{
		return mediaCodeExistsPredicate;
	}

	@Required
	public void setMediaCodeExistsPredicate(final Predicate<MediaData> mediaCodeExistsPredicate)
	{
