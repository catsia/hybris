...
public class SiteMessageController
{
	...
	@Parameter(name = "needsTotal", description = "The flag for indicating if total number of results is needed or not.", schema = @Schema(allowableValues = {"true", "false"}, defaultValue = "true", type = "string"), required = false, in = ParameterIn.QUERY)
