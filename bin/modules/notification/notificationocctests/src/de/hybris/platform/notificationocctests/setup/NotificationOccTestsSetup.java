...
public class NotificationOccTestsSetup extends CommercewebservicesTestSetup
{
	@Resource
	...
	{
		getSetupImpexService().importImpexFile("/notificationocctests/import/coredata/common/essential-data.impex", false);
