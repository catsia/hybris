...
public class NotificationPreferenceController
{
	...
	@ResponseBody
	@Operation(summary = "Gets all notification preferences of the current customer", description = "Returns the notification preferences of the current customer.")
	...
	@Operation(summary = "Updates the notification preferences of the current customer", description = "Updates the notification preference of the current customer.")
	@ApiBaseSiteIdAndUserIdParam
	public void updateNotificationPreferences(
			@Parameter(description = "Notification preference list", required = true) @RequestBody final BasicNotificationPreferenceListWsDTO notificationPreferences)
	{
