...
public class PaymentInfoController
{
	...
	@Operation(summary = "Updates Chinese payment info for a cart.", description = "Updates Chinese payment info for a cart.")
	@ApiBaseSiteIdUserIdAndCartIdParam
	public void replaceChinesePaymentInfo(
			@Parameter(description = "Payment mode code which is used to set payment provider in Chinese payment info.", required = true)
	@RequestParam
	...
	@ResponseBody()
	@Operation(summary = "Creates an order which is specific for China.", description = "The check out process is different in China and it needs to create order first and not to trigger order process.")
	@ApiBaseSiteIdUserIdAndCartIdParam
	...
	@ResponseBody()
	@Operation(summary = "Creates Chinese payment request data base on the Chinese payment info which is set in cart.", description = "Creates Chinese payment request data base on the Chinese payment info which is set in cart.")
	@ApiBaseSiteIdAndUserIdParam
	public ChinesePaymentRequestWsDTO createChinesePaymentRequest(
			@Parameter(description = "Order GUID (Globally Unique Identifier) or order CODE", required = true) @PathVariable("orderCode") final String orderCode,
			@ApiFieldsParam @RequestParam(defaultValue = "DEFAULT") final String fields)
	{
