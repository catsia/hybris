...
public class PaymentInfoController
{
	...
	@Operation(summary = "Updates Chinese payment info for a cart.", description = "Updates Chinese payment mode code for a cart.")
	...
	@ResponseBody()
	@Operation(summary = "Creates Chinese payment request data for an order.", description = "Creates Chinese payment request data base on the Chinese payment info which is set in cart.")
