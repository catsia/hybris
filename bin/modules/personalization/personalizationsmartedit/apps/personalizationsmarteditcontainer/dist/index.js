...
exports.CustomizationsListComponent = class CustomizationsListComponent {
    ...
    getSelectedVariationClass(variation) {
        if (lodash__namespace.isEqual(variation.code, (this.personalizationsmarteditContextService.getCustomize().selectedVariations ||
            {}).code)) {
