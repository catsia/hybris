...
public class ConsignmentTrackingController
{
	...
	@Operation(summary = "Gets consignment tracking information", description = "Returns details of consignment tracking information based on the order code and the consignment code.")
	@ApiBaseSiteIdAndUserIdParam
	public ConsignmentTrackingWsDTO getConsignmentTrackingData(
			@Parameter(description = "order identifier", required = true) @PathVariable("orderCode") final String orderCode,
			@Parameter(description = "consignment identifier", required = true) @PathVariable("consignmentCode") final String consignmentCode)
	{
