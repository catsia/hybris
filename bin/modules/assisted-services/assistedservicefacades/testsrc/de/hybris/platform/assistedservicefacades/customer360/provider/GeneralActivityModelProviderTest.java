...
public class GeneralActivityModelProviderTest
{
	...
	public void testDataProviding()
	{
		...
		final GeneralActivityData resultCart = provider.getModel(new HashMap<>()).getGeneralActivities().get(1);
		final GeneralActivityData resultOrder = provider.getModel(new HashMap<>()).getGeneralActivities().get(0);
