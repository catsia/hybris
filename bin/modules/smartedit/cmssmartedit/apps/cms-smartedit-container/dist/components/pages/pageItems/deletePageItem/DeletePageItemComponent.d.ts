...
export declare class DeletePageItemComponent implements OnInit {
    ...
    constructor(dropdownMenuData: IDropdownMenuItemData, managePageService: ManagePageService, systemEventService: SystemEventService, catalogService: ICatalogService, ref: ChangeDetectorRef, userTrackingService: UserTrackingService);
