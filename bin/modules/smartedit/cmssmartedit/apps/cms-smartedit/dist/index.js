...
/* @ngInject */ exports.ComponentEditingFacade = __decorate([
    smarteditcommons.SeDowngradeService(cmscommons.IComponentEditingFacade),
...
/* @ngInject */ exports.ComponentMenuConditionAndCallbackService = class /* @ngInject */ ComponentMenuConditionAndCallbackService extends cmscommons.IComponentMenuConditionAndCallbackService {
    ...
    externalCondition(configuration) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield this.componentHandlerService.isExternalComponent(configuration.componentId, configuration.componentType);
        });
    }
    ...
    dragCondition(configuration) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const slotEditable = yield this.slotRestrictionsService.isSlotEditable(slotId);
            if (slotEditable) {
                const hasUpdatePermission = yield this.typePermissionsRestService.hasUpdatePermissionForTypes([configuration.componentType]);
