...
const scopes = [];
function angularJSDecoratorCustomElementClassFactory(upgrade, nodeUtils) {
    return class extends smarteditcommons.AbstractAngularJSBasedCustomElement {
        ...
        internalConnectedCallback() {
            ...
            try {
                nodeUtils.collectSmarteditAttributesByElementUuid(this.getAttribute(smarteditcommons.ELEMENT_UUID_ATTRIBUTE));
            }
            catch (e) {
...
/* @ngInject */ exports.LegacyDecoratorToCustomElementConverter = class /* @ngInject */ LegacyDecoratorToCustomElementConverter {
    ...
    convert(_componentName) {
        ...
        const originalName = lodash__namespace.kebabCase(componentName);
        if (!customElements.get(originalName)) {
            // may already have been defined through DI
            const CustomComponentClass = angularJSDecoratorCustomElementClassFactory(this.upgrade, this.nodeUtils);
...
exports.ToolbarServiceFactory.$inject = ["gatewayProxy", "logService", "permissionService"];
...
/* @ngInject */ exports.ComponentHandlerService = class /* @ngInject */ ComponentHandlerService extends smarteditcommons.IComponentHandlerService {
    constructor(yjQuery) {
        super(yjQuery);
    }
...
let /* @ngInject */ SmartEditContractChangeListener = class /* @ngInject */ SmartEditContractChangeListener {
    ...
    initListener() {
        ...
        this.resizeObserver = new ResizeObserver__default["default"](this.resizeObserverCallback.bind(this));
