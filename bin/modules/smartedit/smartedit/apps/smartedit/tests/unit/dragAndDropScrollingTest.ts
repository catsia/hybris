...
describe('dragAndDropScrollingService', () => {
    ...
    describe('initialize', () => {
        ...
        beforeEach(function () {
            ...
            spyOn(dragAndDropScrollingService as any, 'getFromSelector').and.returnValue(selector);
            spyOn(dragAndDropScrollingService as any, 'getFromElementSelector').and.returnValue(
                selector
            );
        });
        ...
        it('GIVEN the document.documentElement is defined THEN the scrollable area is the document.documentElement', () => {
            // Arrange
            expect(
                (dragAndDropScrollingService as any).getFromElementSelector
            ...
            expect(
                (dragAndDropScrollingService as any).getFromElementSelector
            ).toHaveBeenCalledWith(document.documentElement);
        });
    });
    ...
    it('WHEN addScrollAreas is called THEN scroll areas are added', async () => {
        ...
        spyOn(dragAndDropScrollingService as any, 'getFromSelector').and.callFake((arg: any) => {
        ...
        // Assert
        expect((dragAndDropScrollingService as any).getFromSelector).toHaveBeenCalledWith(
    ...
    it('WHEN mouse enters the UI scrolling hints THEN animation starts', () => {
        ...
        spyOn(dragAndDropScrollingService as any, 'getFromSelector').and.returnValue(scrollArea);
    ...
    describe('on mouse over', () => {
        ...
        beforeEach(function () {
            ...
            spyOn(dragAndDropScrollingService as any, 'getFromSelector').and.callFake(
                (arg: any) => {
                    if (arg === 'target') {
                        return scrollArea;
                    } else {
    ...
    it('WHEN enable is called THEN the scroll areas are shown', () => {
        ...
        spyOn(dragAndDropScrollingService as any, 'getFromSelector').and.returnValue(window);
        spyOn(dragAndDropScrollingService as any, 'showScrollAreas');
