...
describe('notificationMouseLeaveDetectionService', () => {
    ...
    describe('_callCallback', () => {
        it('calls the mouse leave callback', async () => {
            // Given
            const callBackFnSpy = jasmine.createSpy('callBackFn');
            const cbPromise = Promise.resolve(callBackFnSpy);
            ...
            // When
            await (notificationMouseLeaveDetectionService as any)._callCallback();
    ...
    describe('_onMouseLeave', () => {
        it('calls the callback function if it is defined locally', async () => {
            // Given
            const callBackFnSpy = jasmine.createSpy('callBackFn');

            const callback = Promise.resolve(callBackFnSpy);
            ...
            // When
            await (notificationMouseLeaveDetectionService as any)._onMouseLeave();
        ...
        it('calls the callback function remotely if it is not defined locally', async () => {
            // Given
            const callback = Promise.resolve(null);
            const callcallback = Promise.resolve(null);
            spyOn(notificationMouseLeaveDetectionService as any, '_getCallback').and.returnValue(
                callback
            );
        ...
        it('stops detection', async () => {
            // Given
            const callback = Promise.resolve(function () {});
            spyOn(notificationMouseLeaveDetectionService as any, '_getCallback').and.returnValue(
                callback
            );
            spyOn(notificationMouseLeaveDetectionService, 'stopDetection');
    ...
    describe('_onMouseMove', () => {
        describe('', () => {
            beforeEach(() => {
                const nullBoundsPromise = Promise.resolve(null);
        ...
        describe('', () => {
             ...
             */
            beforeEach(() => {
                const boundsPromise: Promise<IBound> = Promise.resolve(DUMMY_BOUNDS);
                spyOn(notificationMouseLeaveDetectionService as any, '_getBounds').and.returnValue(
                    boundsPromise
                );
                spyOn(notificationMouseLeaveDetectionService as any, '_onMouseLeave');
