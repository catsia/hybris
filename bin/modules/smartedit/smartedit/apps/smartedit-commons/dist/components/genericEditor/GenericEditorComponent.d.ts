...
export declare class GenericEditorComponent implements OnChanges {
    ...
    private formSet$;
    constructor(elementRef: ElementRef<HTMLElement>, genericEditorFactoryService: GenericEditorFactoryService, waitDialogService: IWaitDialogService, yjQuery: JQueryStatic);
