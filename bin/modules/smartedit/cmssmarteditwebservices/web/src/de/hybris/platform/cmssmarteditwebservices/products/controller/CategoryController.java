...
public class CategoryController
{
	...
	@ResponseBody
	@Operation(operationId = "getCategoryByCode", summary = "Get category by code (uuid)", description = "Endpoint to retrieve a category that matches the given product category code uuid.")
	...
	public CategoryWsDTO getCategoryByCode( //
			@Parameter(description = "Category code (uuid)", required = true) //
			@PathVariable
			final String code)
	{
