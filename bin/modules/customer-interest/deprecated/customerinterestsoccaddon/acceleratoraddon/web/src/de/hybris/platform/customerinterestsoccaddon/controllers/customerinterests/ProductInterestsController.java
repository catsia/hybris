...
public class ProductInterestsController
{
	...
	@Operation(summary = "Sets product interests for a user.", description = "Sets product interests for a user.")
	...
	@Operation(summary = "Gets product interests for a user.", description = "Gets product interests for a user.")
