...
public class SnIndexerCronJobSpec extends AbstractSnIndexerSpec {
	...
	public void runFullCronJobOperation() {
		...
		searchResponse.getSearchResult().getCount() == PRODUCTS_COUNT
	}
	...
	public void runIncrementalCronJobAfterFullOperation() {
		...
		searchResponse != null
		searchResponse.getSearchResult() != null
		searchResponse.getSearchResult().getCount() == PRODUCTS_COUNT + PRODUCTS_CREATED_COUNT
	}
	...
	public void runIncrementalCronJobAfterFullAndIncrementalOperation() {
		...
		searchResponse != null
		searchResponse.getSearchResult() != null
		searchResponse.getSearchResult().getCount() == PRODUCTS_COUNT + PRODUCTS_CREATED_COUNT + PRODUCTS_CREATED_COUNT
	}
	...
	public void runPartialCronJobAfterFullOperation() {
		...
		searchResponse != null
		searchResponse.getSearchResult() != null
		searchResponse.getSearchResult().getCount() == 2
