...
{
	@GET
	@Path(SearchprovidercssearchservicesConstants.PATH_TASK)
	@Produces(MediaType.APPLICATION_JSON)
	Observable<RawResponse<TaskDTO>> getTask(@PathParam("taskId") final String taskId);

	@GET
	@Path(SearchprovidercssearchservicesConstants.PATH_INDEX_CONFIGURATION)
	...
	@POST
	@Path(SearchprovidercssearchservicesConstants.PATH_INDEX_CONFIGURATIONS)
	@Produces(MediaType.APPLICATION_JSON)
	...
	@GET
	@Path(SearchprovidercssearchservicesConstants.PATH_INDEX_TYPE)
	Observable<RawResponse<IndexTypeDTO>> getIndexType(@PathParam("indexTypeId") final String indexTypeId);

	@POST
	@Path(SearchprovidercssearchservicesConstants.PATH_INDEX_TYPES)
	@Produces(MediaType.APPLICATION_JSON)
	...
	@GET
	@Path(SearchprovidercssearchservicesConstants.PATH_INDEX_TYPE_FIELD)
	...
	@POST
	@Path(SearchprovidercssearchservicesConstants.PATH_INDEX_TYPE_FIELDS)
	@Produces(MediaType.APPLICATION_JSON)
	...
	@GET
	@Path(SearchprovidercssearchservicesConstants.PATH_SYNONYM_DICTIONARY)
	...
	@POST
	@Path(SearchprovidercssearchservicesConstants.PATH_SYNONYM_DICTIONARIES)
	@Produces(MediaType.APPLICATION_JSON)
	...
	@POST
	@Path(SearchprovidercssearchservicesConstants.PATH_INDEX_STATE)
	@Produces(MediaType.APPLICATION_JSON)
	Observable<RawResponse<AbstractIndexStateResponseDTO>> executeIndexStateRequest(@PathParam("indexId") final String indexId,
			AbstractIndexStateRequestDTO indexStateRequest);
	...
	@Produces(MediaType.APPLICATION_JSON)
	Observable<RawResponse<IndexerOperationDTO>> getIndexerOperation(
			@PathParam("indexerOperationId") final String indexerOperationId);
	...
	@POST
	@Path(SearchprovidercssearchservicesConstants.PATH_INDEXER_OPERATION_STATE)
	@Produces(MediaType.APPLICATION_JSON)
	Observable<RawResponse<Void>> executeIndexerOperationStateRequest(
			@PathParam("indexerOperationId") final String indexerOperationId,
	...
	@Produces(MediaType.APPLICATION_JSON)
	Observable<RawResponse<AsyncTaskResponseDTO>> executeDocumentBatch(@PathParam("indexId") final String indexId,
