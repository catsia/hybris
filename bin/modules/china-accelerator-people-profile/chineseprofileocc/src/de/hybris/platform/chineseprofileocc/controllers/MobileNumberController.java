...
public class MobileNumberController
{
	...
	@ResponseBody
	@Operation(summary = "Binds mobile number for the customer.", description = "Binds mobile number for the customer based on a valid verification code..")
	@ApiBaseSiteIdAndUserIdParam
	...
	@ResponseStatus(HttpStatus.OK)
	@Operation(summary = "Unbinds mobile number for the customer.", description = "Unbinds mobile number for the customer based on a valid verification code..")
	@ApiBaseSiteIdAndUserIdParam
