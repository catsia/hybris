...
public class ChineseProfileOccTestSetup extends CommercewebservicesTestSetup
{
	@Resource
	...
	{
		getSetupImpexService().importImpexFile("/chineseprofileocctests/import/sampledata/wsCommerceOrg/test-data.impex", false);
