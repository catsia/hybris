...
public class OrderApprovalPermissionsController extends BaseController
{
	...
	@ResponseBody
	@Operation(operationId = "getOrderApprovalPermissions", summary = "Get order approval permissions.", description = "Returns the list of order approval permissions for the company of the identified user. The response can display the results across multiple pages, if required.")
	...
	@ResponseBody
	@Operation(operationId = "getOrderApprovalPermission", summary = "Get an order approval permission.", description = "Returns a specific order approval permission based on specific code. The response contains detailed order approval permission information.")
	@ApiBaseSiteIdAndUserIdParam
	public B2BPermissionWsDTO getOrderApprovalPermission(
			@Parameter(description = "Order Approval Permission identifier", required = true) @PathVariable final String orderApprovalPermissionCode,
			@ApiFieldsParam @RequestParam(defaultValue = DEFAULT_FIELD_SET) final String fields)
	{
	...
	@Operation(operationId = "updateOrderApprovalPermission", summary = "Update the order approval permission", description = "Updates the order approval permission. Only attributes provided in the request body will be changed.")
	@ApiBaseSiteIdAndUserIdParam
	@ResponseBody
	...
	@Operation(operationId = "createOrderApprovalPermission", summary = "Create a new order approval permission.", description = "Creates a new order approval permission.")
	@ApiBaseSiteIdAndUserIdParam
