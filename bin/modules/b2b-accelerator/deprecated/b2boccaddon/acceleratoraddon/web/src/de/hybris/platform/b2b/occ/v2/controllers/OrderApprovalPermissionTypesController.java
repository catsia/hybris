...
public class OrderApprovalPermissionTypesController extends BaseController
{
	...
	@ResponseBody
	@Operation(operationId = "getOrderApprovalPermissionTypes", summary = "Get order approval permission types.", description = "Returns the list of order approval permission types.")
	@ApiBaseSiteIdParam
