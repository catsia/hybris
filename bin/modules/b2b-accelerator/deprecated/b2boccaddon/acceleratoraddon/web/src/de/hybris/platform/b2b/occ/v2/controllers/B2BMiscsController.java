...
public class B2BMiscsController extends BaseController
{
	...
	@ResponseBody
	@Operation(operationId = "getPaymentTypes", summary = "Returns a list of the available payment types.", description = "Returns a list of the available payment types in the B2B checkout process.")
	@ApiBaseSiteIdParam
