...
public class B2BProductsController extends BaseController
{
	...
	@ResponseBody
	@ApiBaseSiteIdParam
	@Operation(operationId = "getOrgProduct", summary = "Returns a product.", description = "Returns a product, based on the specified product code.")
	public ProductWsDTO getProductByCode(
			@Parameter(description = "The product code", required = true) @PathVariable final String productCode,
