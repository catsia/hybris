...
public class CCPControllerHelperImplTest extends AbstractProductConfiguratorCCPControllerTCBase
{
	...
	{
		assertNull(classUnderTest.mapDTOData(configurationData).getKbKey());
	}
	...
	public void testMapDTODataExpertModeActive()
	{
		...
		assertEquals(kbKeyWs, classUnderTest.mapDTOData(configurationData).getKbKey());
	}
	...
	public void testMapDTODataConsiderBuildNumber()
	{
		...
		assertEquals(KB_BUILD_NUMBER, classUnderTest.mapDTOData(configurationData).getKbKey().getKbBuildNumber());
	}
	...
	public void testMapDTODataConsiderPricingEnabled()
	{
		...
		assertTrue(classUnderTest.mapDTOData(configurationData).isPricingEnabled());
	}
