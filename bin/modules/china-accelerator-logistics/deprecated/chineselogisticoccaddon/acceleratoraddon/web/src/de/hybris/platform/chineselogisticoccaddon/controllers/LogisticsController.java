...
public class LogisticsController
{
	...
	@Operation(summary = "Gets delivery timeslots.", description = "Gets delivery timeslots.")
	@ApiBaseSiteIdParam
	...
	@Operation(summary = "Updates delivery timeslot for a cart.", description = "Updates delivery timeslot for a cart.")
	@ApiBaseSiteIdUserIdAndCartIdParam
	public void replaceDeliveryTimeSlot(
			@Parameter(description = "Delivery time slot code", required = true)
			@RequestParam
	...
	@ResponseStatus(HttpStatus.OK)
	@Operation(summary = "Deletes delivery timeslot from the cart.", description = "Deletes delivery timeslot from the cart.")
	@ApiBaseSiteIdUserIdAndCartIdParam
