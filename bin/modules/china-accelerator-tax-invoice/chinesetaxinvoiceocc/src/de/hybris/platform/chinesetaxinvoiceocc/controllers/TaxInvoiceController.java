...
public class TaxInvoiceController
{
	...
	@ResponseBody
	@Operation(summary = "Gets tax invoice recipient types.", description = "Returns recipient types for tax invoice.")
	@ApiBaseSiteIdParam
	...
	@Operation(summary = "Deletes tax invoice from the cart.", description = "Removes tax invoice from the cart.")
	...
	@ResponseStatus(HttpStatus.OK)
	@Operation(summary = "Sets tax invoice for a cart.", description = "Updates tax invoice for a cart.")
	@ApiBaseSiteIdUserIdAndCartIdParam
